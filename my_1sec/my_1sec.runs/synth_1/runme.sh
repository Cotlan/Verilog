...
HD_PWD='C:/Verilog/my_1sec/my_1sec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_1sec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_1sec.tcl
