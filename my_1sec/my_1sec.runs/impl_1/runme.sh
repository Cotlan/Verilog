...
HD_PWD='C:/Verilog/my_1sec/my_1sec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_1sec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_1sec.tcl -notrace
