...
HD_PWD='C:/Verilog/my_disp/my_disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_disp.tcl
