...
HD_PWD='C:/Verilog/my_disp/my_disp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_disp.tcl -notrace
