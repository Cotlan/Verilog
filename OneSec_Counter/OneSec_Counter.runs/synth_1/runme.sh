...
HD_PWD='C:/Verilog/OneSec_Counter/OneSec_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OneSec_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OneSec_Counter.tcl
