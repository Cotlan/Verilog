...
HD_PWD='C:/Verilog/OneSec_Counter/OneSec_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OneSec_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OneSec_Counter.tcl -notrace
