...
HD_PWD='C:/Verilog/my_sw2LED/my_sw2LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_sw2LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_sw2LED.tcl -notrace
