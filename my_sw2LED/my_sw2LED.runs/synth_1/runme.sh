...
HD_PWD='C:/Verilog/my_sw2LED/my_sw2LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_sw2LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_sw2LED.tcl
