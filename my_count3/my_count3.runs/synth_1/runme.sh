...
HD_PWD='C:/verilog_lab/my_count3/my_count3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_cnt3.tcl
