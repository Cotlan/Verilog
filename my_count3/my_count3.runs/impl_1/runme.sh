...
HD_PWD='C:/verilog_lab/my_count3/my_count3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_cnt3.tcl -notrace
