...
HD_PWD='C:/Verilog/mycount_32_prac/mycount_32_prac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myCount32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myCount32.tcl
