...
HD_PWD='C:/Verilog/mycount_32_prac/mycount_32_prac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myCount32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myCount32.tcl -notrace
