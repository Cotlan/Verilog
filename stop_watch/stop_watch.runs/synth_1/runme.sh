...
HD_PWD='C:/Verilog/stop_watch/stop_watch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stop_watch.tcl
