...
HD_PWD='C:/Verilog/stop_watch/stop_watch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stop_watch.tcl -notrace
