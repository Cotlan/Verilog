...
HD_PWD='C:/Verilog/practico_UART_11_13/practico_UART_11_13.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_TX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_TX.tcl -notrace
