...
HD_PWD='C:/Verilog/practico_UART_11_13/practico_UART_11_13.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_TX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_TX.tcl
