...
HD_PWD='C:/Verilog/my_serdes2/my_serdes2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_serdes_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_serdes_tb.tcl
