...
HD_PWD='C:/Verilog/test_zynq_11_26/test_zynq_11_26.runs/zynq_basys_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_basys_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_basys_axi_gpio_0_0.tcl
