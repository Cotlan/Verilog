...
HD_PWD='C:/Verilog/traffic_FSM/traffic_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_FSM.tcl
