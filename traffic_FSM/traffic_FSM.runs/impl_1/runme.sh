...
HD_PWD='C:/Verilog/traffic_FSM/traffic_FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_FSM.tcl -notrace
