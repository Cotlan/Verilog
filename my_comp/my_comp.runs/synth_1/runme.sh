...
HD_PWD='C:/Verilog/my_comp/my_comp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_comp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_comp.tcl
