...
HD_PWD='C:/Verilog/my_comp/my_comp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_comp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_comp.tcl -notrace
