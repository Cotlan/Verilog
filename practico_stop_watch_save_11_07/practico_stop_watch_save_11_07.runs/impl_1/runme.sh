...
HD_PWD='C:/Verilog/practico_stop_watch_save_11_07/practico_stop_watch_save_11_07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log practico_stop_watch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source practico_stop_watch.tcl -notrace
