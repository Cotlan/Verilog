...
HD_PWD='C:/Verilog/practico_stop_watch_save_11_07/practico_stop_watch_save_11_07.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practico_stop_watch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practico_stop_watch.tcl
