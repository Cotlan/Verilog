...
HD_PWD='C:/Verilog/project_14/project_14.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log apb_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source apb_uart.tcl
