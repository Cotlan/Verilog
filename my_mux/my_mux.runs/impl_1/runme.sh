...
HD_PWD='C:/Verilog/my_mux/my_mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_mux.tcl -notrace
