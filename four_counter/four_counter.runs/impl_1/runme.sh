...
HD_PWD='C:/verilog_lab/four_counter/four_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_counter.tcl -notrace
