...
HD_PWD='C:/verilog_lab/four_counter/four_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Four_counter.tcl
