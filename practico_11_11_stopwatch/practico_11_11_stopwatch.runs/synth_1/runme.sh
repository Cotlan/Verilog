...
HD_PWD='C:/Verilog/practico_11_11_stopwatch/practico_11_11_stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stop_watch_top.tcl
