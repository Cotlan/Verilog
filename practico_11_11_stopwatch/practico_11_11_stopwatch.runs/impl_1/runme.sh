...
HD_PWD='C:/Verilog/practico_11_11_stopwatch/practico_11_11_stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stop_watch_top.tcl -notrace
