...
/* Definitions for peripheral AXI_GPIO_IP */
#define XPAR_AXI_GPIO_DIP_COMPATIBLE xlnx,axi-gpio-2.0
#define XPAR_AXI_GPIO_DIP_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_DIP_HIGHADDR 0x4120ffff
#define XPAR_AXI_GPIO_DIP_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_DIP_IS_DUAL 0x0
#define XPAR_AXI_GPIO_DIP_GPIO_WIDTH 0x2
...
#define XPAR_AXI_GPIO_LED_GPIO_WIDTH 0x6
