...
HD_PWD='C:/Verilog/FSM_security/FSM_security.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Security.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_Security.tcl -notrace
