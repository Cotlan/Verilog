...
HD_PWD='C:/Verilog/FSM_security/FSM_security.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Security.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_Security.tcl
