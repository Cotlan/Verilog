...
HD_PWD='C:/Verilog/zynq_basic_system/zynq_basic_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_basys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_basys_wrapper.tcl
