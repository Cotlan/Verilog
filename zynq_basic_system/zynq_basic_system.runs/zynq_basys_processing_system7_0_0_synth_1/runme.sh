...
HD_PWD='C:/Verilog/zynq_basic_system/zynq_basic_system.runs/zynq_basys_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_basys_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_basys_processing_system7_0_0.tcl
