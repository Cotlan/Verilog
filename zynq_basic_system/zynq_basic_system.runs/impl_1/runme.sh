...
HD_PWD='C:/Verilog/zynq_basic_system/zynq_basic_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_basys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_basys_wrapper.tcl -notrace
