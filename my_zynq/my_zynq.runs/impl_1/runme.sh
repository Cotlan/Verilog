...
HD_PWD='C:/Verilog/my_zynq/my_zynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_bd_wrapper.tcl -notrace
