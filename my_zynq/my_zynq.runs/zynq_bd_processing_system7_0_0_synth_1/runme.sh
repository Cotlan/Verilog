...
HD_PWD='C:/Verilog/my_zynq/my_zynq.runs/zynq_bd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_bd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_bd_processing_system7_0_0.tcl
