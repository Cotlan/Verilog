...
HD_PWD='C:/Verilog/my_zynq/my_zynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_bd_wrapper.tcl
