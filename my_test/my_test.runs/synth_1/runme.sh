...
HD_PWD='C:/verilog_lab/my_test/my_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_module.tcl
