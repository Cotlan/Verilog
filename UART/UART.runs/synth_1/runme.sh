...
HD_PWD='C:/Verilog/UART/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_uart_TX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_uart_TX.tcl
