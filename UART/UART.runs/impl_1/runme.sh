...
HD_PWD='C:/Verilog/UART/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_uart_TX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_uart_TX.tcl -notrace
